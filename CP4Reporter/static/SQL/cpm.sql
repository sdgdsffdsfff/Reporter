...
WHERE
         ji.issuetype = 1 AND ji.REPORTER in (SELECT lower_user_name FROM cwd_user cu LEFT JOIN cwd_membership cms ON cu.ID = cms.child_id where cms.parent_id = 29988)
